...
extern "C"
{
	...
	{
		gLog.OpenRelative(CSIDL_MYDOCUMENTS, "\\My Games\\Skyrim Special Edition\\SKSE\\Fuz Ro Bork.log");
	...
	bool SKSEPlugin_Load(const SKSEInterface * skse)
	{
		...
		FuzRoBorkINIManager::Instance.Initialize("Data\\SKSE\\Plugins\\Fuz Ro Bork.ini", nullptr);
